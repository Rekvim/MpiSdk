...
void MainTest::Process()
{
    ...
    QVector<QPointF> points_backward = GetRegressionPoints(regressionBackward, regressionLimits);

    pointsForward.append({points_backward.rbegin(), points_backward.rend()});
